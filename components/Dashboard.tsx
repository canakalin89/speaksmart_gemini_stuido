        ...
        <div className="w-full grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
                <div className="flex items-center gap-4 mb-4">
                    <span className="flex items-center justify-center w-8 h-8 bg-amber-100 text-amber-700 font-bold rounded-full flex-shrink-0">2</span>
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-800">{t('review-results')}</h2>
                </div>
                <p className="text-slate-500 mb-10 sm:mb-12 ml-12 text-sm sm:text-base">{t('review-results-desc')}</p>
