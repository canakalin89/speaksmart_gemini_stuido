  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-1 text-zinc-800">{t('evaluation-results')}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
       ...
       <div className="text-center pt-4">
            <button onClick={onTryAgain} className="bg-indigo-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-indigo-700 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2">
                {t('try-again')}
            </button>
        </div>
    </div>
